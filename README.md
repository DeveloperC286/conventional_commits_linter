...
jobs:
  linting:
    ...
    container:
      image: ghcr.io/developerc286/conventional_commits_linter:0.16.2
    steps:
      - name: Checkout code.
...
conventional-commits-linting:
    ...
    image: rust
    before_script:
        - version="v0.16.2" && wget -O - "https://github.com/DeveloperC286/conventional_commits_linter/releases/download/${version}/x86_64-unknown-linux-musl.tar.gz" | tar xz --directory "/usr/bin/"
    script:
...
<!-- x-release-please-start-version -->
```sh
cargo install conventional_commits_linter --version 0.16.2
```
<!-- x-release-please-end -->
