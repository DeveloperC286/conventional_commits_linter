  ...
  conventional-commits-linting:
    ...
    - uses: actions/checkout@11bd71901bbe5b1630ceea73d27597364c9af683 # v4.2.2
      with:
        fetch-depth: 0
    - name: Lint commits
      run: conventional_commits_linter "origin/${{ github.base_ref }}" --commit-type angular
```
...
conventional-commits-linting:
    ...
    script:
        ...
        - conventional_commits_linter "origin/${CI_MERGE_REQUEST_TARGET_BRANCH_NAME}" --commit-type angular
    rules:
